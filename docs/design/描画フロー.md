...
flowchart TD
    ...
    style C fill:#ddf4ff,stroke:#0a4f9e
    style F fill:#dafbe1,stroke:#0d4f21
...
flowchart TD
    ...
    style S1 fill:#fff8c5,stroke:#8a6d00
    style S4 fill:#ddf4ff,stroke:#0a4f9e
    style S7 fill:#fff8c5,stroke:#8a6d00
    style S11 fill:#fff8c5,stroke:#8a6d00
```
...
flowchart TD
    ...
    style W0 fill:#fff8c5,stroke:#8a6d00
    style G10 fill:#dafbe1,stroke:#0d4f21
    style G12 fill:#ddf4ff,stroke:#0a4f9e
```
...
flowchart LR
    ...
    style P0 fill:#fff1e5,stroke:#7a3200
    style P1 fill:#fff1e5,stroke:#7a3200
    style P2 fill:#fff1e5,stroke:#7a3200
```
